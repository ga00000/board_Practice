 ...
 */
@Controller
public class JgCmtTwoController {  
    ...
    /** Program ID **/
    private final static String PROGRAM_ID = "JgCmtTwo"; 

    /** folderPath **/
    private final static String folderPath = "/ma/comment/jgCmtTwo/"; 
	...
	public String addList(@ModelAttribute("searchVO") CmmnDefaultVO searchVO, ModelMap model, HttpServletRequest request) throws Exception {
		...
		List<JgCmtTwoVO> resultList = (List<JgCmtTwoVO>) cmmnService.selectList(searchVO, PROGRAM_ID );
	...
	public String view(@ModelAttribute("searchVO") JgCmtTwoVO searchVO, Model model, HttpServletRequest request) throws Exception {
		/* 게시판  */
		JgCmtTwoVO jgCmtTwoVO = new JgCmtTwoVO();
		jgCmtTwoVO = (JgCmtTwoVO) cmmnService.selectContents(searchVO, PROGRAM_ID);
		model.addAttribute("jgCmtTwoVO", jgCmtTwoVO);
	...
	public String addListReply(@ModelAttribute("searchVO") JgCmtTwoVO searchVO, Model model, HttpServletRequest request) throws Exception {
		/* 댓글 1개  */
		JgCmtTwoVO jgCmtTwoVO = new JgCmtTwoVO();
		jgCmtTwoVO = (JgCmtTwoVO) cmmnService.selectContents(searchVO, PROGRAM_ID+".selectComments");
		model.addAttribute("jgCmtTwoVO", jgCmtTwoVO);
	...
	public String form(@ModelAttribute("searchVO") JgCmtTwoVO searchVO, Model model,@PathVariable String procType, HttpServletRequest request) throws Exception {
	...
	public String proc(@ModelAttribute("searchVO") JgCmtTwoVO searchVO, Model model, SessionStatus status,@PathVariable String procType, HttpServletRequest request) throws Exception {
		...
		if(procType != null){   
			...
			if(procType.equals("insert")) {
				...
				searchVO = (JgCmtTwoVO) cmmnService.selectContents(searchVO, PROGRAM_ID+".selectComments");
			...
			if(procType.equals("update")){
				...
				model.addAttribute("jgCmtTwoVO", searchVO);
				return folderPath + "addListReply";

 ...
 */
@Alias("jgCmtTwoVO")
public class JgCmtTwoVO extends CmmnDefaultVO implements Serializable {
	/**
	 * 
	 */
	...
	public String getJgReplyUseYn() {
		return jgReplyUseYn;
	}


	public void setJgReplyUseYn(String jgReplyUseYn) {
		this.jgReplyUseYn = jgReplyUseYn;
	}

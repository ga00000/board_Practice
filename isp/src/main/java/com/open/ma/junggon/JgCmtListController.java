...
import com.open.ma.junggon.service.JgCmtListVO;
 ...
 */
@Controller
public class JgCmtListController {  
    ...
    /** Program ID **/
    private final static String PROGRAM_ID = "JgCmtList"; 

    /** folderPath **/
    private final static String folderPath = "/ma/comment/jgCmtList/"; 
	...
	public String addList(@ModelAttribute("searchVO") CmmnDefaultVO searchVO, ModelMap model, HttpServletRequest request) throws Exception {
		...
		List<JgCmtListVO> resultList = (List<JgCmtListVO>) cmmnService.selectList(searchVO, PROGRAM_ID );
	...
	public String view(@ModelAttribute("searchVO") JgCmtListVO searchVO, Model model, HttpServletRequest request) throws Exception {
		/* 게시판  */
		JgCmtListVO jgCmtListVO = new JgCmtListVO();
		jgCmtListVO = (JgCmtListVO) cmmnService.selectContents(searchVO, PROGRAM_ID);
		model.addAttribute("jgCmtListVO", jgCmtListVO);
		/* 댓글  */
		List<JgCmtListVO> cmtList = (List<JgCmtListVO>) cmmnService.selectList(searchVO, PROGRAM_ID + ".selectComments");
	...
	public String form(@ModelAttribute("searchVO") JgCmtListVO searchVO, Model model,@PathVariable String procType, HttpServletRequest request) throws Exception {
	...
	public String proc(@ModelAttribute("searchVO") JgCmtListVO searchVO, Model model, SessionStatus status,@PathVariable String procType, HttpServletRequest request) throws Exception {
		if(procType != null){
			...
			if(procType.equals("update")){
				...
				model.addAttribute("pName", "jgSeq");	
				model.addAttribute("pValue", searchVO.getJgGroupSeq()); 
				model.addAttribute("cmmnScript", "view.do");
				return "cmmn/execute";
	    	}else if(procType.equals("updateRe") ){  /*게시글seq -> 댓글seq*/
				model.addAttribute("message", "댓글이 수정되었습니다..");
				model.addAttribute("pName", "jgSeq");	
				model.addAttribute("pValue", searchVO.getJgGroupSeq()); /*게시글seq = 댓글groupSeq */
				model.addAttribute("cmmnScript", "view.do");
				return "cmmn/execute";

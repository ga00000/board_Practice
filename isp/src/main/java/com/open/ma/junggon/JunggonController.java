...
import com.open.ma.junggon.service.JunggonVO;
 ...
 */
@Controller
public class JunggonController {  
    ...
    /** Program ID **/
    private final static String PROGRAM_ID = "Junggon"; 

    /** folderPath **/
    private final static String folderPath = "/ma/comment/junggon/"; 
	...
	public String addList(@ModelAttribute("searchVO") CmmnDefaultVO searchVO, ModelMap model, HttpServletRequest request) throws Exception {
		...
		List<JunggonVO> resultList = (List<JunggonVO>) cmmnService.selectList(searchVO, PROGRAM_ID );
	...
	public String view(@ModelAttribute("searchVO") JunggonVO searchVO, Model model, HttpServletRequest request) throws Exception {
		
		/* 게시판 상세정보 */
		JunggonVO junggonVO = new JunggonVO();
		junggonVO = (JunggonVO) cmmnService.selectContents(searchVO, PROGRAM_ID);
		model.addAttribute("junggonVO", junggonVO);
	...
	public String form(@ModelAttribute("searchVO") JunggonVO searchVO, Model model,@PathVariable String procType, HttpServletRequest request) throws Exception {
	...
	public String proc(@ModelAttribute("searchVO") JunggonVO searchVO, Model model, SessionStatus status,@PathVariable String procType, HttpServletRequest request) throws Exception {
		...
		if(procType != null){
			...
			} else if (procType.equals("updateRe")) {	/* 댓글등록 및 수정*/		

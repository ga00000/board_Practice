...
<div class="content_box">
	<form:form commandName="jgCmtThreeVO" name="defaultFrm" id="defaultFrm" method="post">
			...
			<table class="tbl_row_type01"> 
				...
				<tbody>
					<tr>
						...
						<td colspan="3">
							<input type="text" name="jgTitle" id="jgTitle" class="text w100p"   maxlength="100"  placeholder="제목을 입력해주세요." value="${util:unEscape(jgCmtThreeVO.jgTitle) }" />
					...
					<tr>
						...
						<td colspan="3">
							<textarea name="jgCont" id="jgCont" class="txt_area w_100p"  maxlength="200" >${jgCmtThreeVO.jgCont}</textarea>
						</td> 
					</tr>
					...
					<tr>
						...
						<td colspan="3">
							<iframe name="jgAtchFileIdFrame" id="jgAtchFileIdFrame" src="/atch/fileUpload.do?atchFileId=${jgCmtThreeVO.jgAtchFileId}&fileCnt=5&atchFileIdNm=jgAtchFileId&updateType=upload" style="width: 100%;" height="50" frameborder="0" title="파일 업로드 폼"></iframe>
						</td>
					</tr> 
